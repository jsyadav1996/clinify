                    ...
                    <form method="POST" action="{{ route('appointments.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            @if(auth()->user()->isClinician())
                                <x-text-input id="clinician_id" type="text" class="mt-1 block w-full bg-gray-100" value="{{ auth()->user()->name }}" disabled />
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button type="submit">Create Appointment</x-primary-button>
